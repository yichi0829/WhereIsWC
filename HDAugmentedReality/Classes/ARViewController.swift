...
//            
            ...
            debugMapButton.frame = CGRect(x: 5,y: 20,width: 60,height: 60);
            debugMapButton.addTarget(self, action: Selector("debugButtonTap"), forControlEvents: UIControlEvents.TouchUpInside)
            debugMapButton.setImage(UIImage(named: "map_view"), forState: .Normal)
            debugMapButton.setTitle("", forState: UIControlState.Normal)
    ...
    */
    ...
    private func calculateDistanceAndAzimuthForAnnotations(sort sort: Bool, onlyForActiveAnnotations: Bool)
    {
        ...
        for annotation in array
        {
            ...
            print("userLocation: ",userLocation.coordinate.longitude,",",userLocation.coordinate.latitude)
            print("annotation: ",annotation.location?.coordinate.longitude,",",annotation.location?.coordinate.latitude)
